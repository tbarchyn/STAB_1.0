...
make_surf_image <- FALSE                # make a surface image
archive_surf_image <- FALSE             # also copy the image and relabel based on iteration
make_sed_depth_image <- FALSE           # make a sediment depth image
archive_sed_depth_image <- FALSE        # also copy the image and relabel based on iteration

add_bsmt_exposure <- TRUE               # add a basement exposure underlay to images to highlight bsmt
